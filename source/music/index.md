...
{% meting "60198" "netease" "playlist" "theme:#4facfe" "order:list" "loop:all" "preload:auto" "listmaxheight:400px" %}

---

## 💡 使用说明

<div style="background: linear-gradient(135deg, rgba(102, 126, 234, 0.1) 0%, rgba(118, 75, 162, 0.1) 100%); border-radius: 15px; padding: 30px; margin: 30px 0;">
...
<div style="background: white; border-radius: 15px; padding: 25px; box-shadow: 0 5px 20px rgba(0,0,0,0.1); text-align: center;">
  ...
  <h3 style="color: #667eea; margin-bottom: 10px;">稳定播放</h3>
  <p style="color: #999;">使用APlayer + MetingJS，自动获取音乐资源</p>
</div>

<div style="background: white; border-radius: 15px; padding: 25px; box-shadow: 0 5px 20px rgba(0,0,0,0.1); text-align: center;">
  <div style="font-size: 3em; margin-bottom: 15px;">📝</div>
  <h3 style="color: #764ba2; margin-bottom: 10px;">歌词同步</h3>
  <p style="color: #999;">实时显示歌词，跟随音乐滚动</p>
</div>

<div style="background: white; border-radius: 15px; padding: 25px; box-shadow: 0 5px 20px rgba(0,0,0,0.1); text-align: center;">
  <div style="font-size: 3em; margin-bottom: 15px;">🎨</div>
  <h3 style="color: #4facfe; margin-bottom: 10px;">精美UI</h3>
  <p style="color: #999;">现代化设计，完美适配移动端</p>
</div>
...
.music-space-header img {
  animation: float 3s ease-in-out infinite;
}

@media (max-width: 768px) {
  .music-space-header h1 {
